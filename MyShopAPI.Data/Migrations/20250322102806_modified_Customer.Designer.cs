...
namespace MyShopAPI.Data.Migrations
{
    ...
    [Migration("20250322102806_modified_Customer")]
    partial class modified_Customer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ce730078-1cb6-404f-9dd7-3d0fbaa89920",
                            Name = "customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "97a8c0f0-332b-49c0-81f3-ac4bf6fabb20",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("MyShopAPI.Data.Entities.DeliveryProfile", b =>
                {
                    b.HasOne("MyShopAPI.Data.Entities.Customer", "Customer")
                        ...
                        .HasForeignKey("MyShopAPI.Data.Entities.DeliveryProfile", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
